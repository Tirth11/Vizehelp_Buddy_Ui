  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={[styles.btn, !valid && styles.btnDisabled]} onPress={handleVerify} disabled={!valid}>
...
const styles = StyleSheet.create({
  ...
  subtitle: { ...FONTS.regular, color: COLORS.textLight, marginBottom: SPACING.xl, lineHeight: 22 },
  ...
  btn: { backgroundColor: COLORS.primary, padding: SPACING.md + 2, borderRadius: RADIUS.md, alignItems: 'center', ...SHADOWS.small },
