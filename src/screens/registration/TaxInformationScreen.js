...
export default function TaxInformationScreen({ navigation }) {
  const [form, setForm] = useState({ taxClass: '', legalName: '', businessName: '', tin: '', taxAddress: '' });
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Please provide your tax information so payouts and annual tax reporting (1099-NEC) can be processed correctly.</Text>
      ...
      <TextInput style={styles.input} placeholder="SSN / EIN / TIN *" keyboardType="number-pad" secureTextEntry value={form.tin} onChangeText={v => setForm({ ...form, tin: v })} />
      ...
      <TouchableOpacity style={[styles.btn, !w9Cert && styles.btnDisabled]} disabled={!w9Cert} onPress={() => navigation.navigate('BankDetails')}>
